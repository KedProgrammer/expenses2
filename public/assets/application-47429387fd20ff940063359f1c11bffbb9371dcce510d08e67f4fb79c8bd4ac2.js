...
(function() {
  $(document).ready(function() {
    var Filter, QueryString, filter, params, query;
    params = ['', '', '', '', ''];
    Filter = (function() {
      ...
      Filter.prototype.asign1 = function() {
        var aux, id;
        aux = [];
        id = $(this).attr('id');
        ...
        return query.put_url(params);
      };

      Filter.prototype.filter_type = function() {
      ...
      Filter.prototype.filter_category = function() {
        if ($(this).hasClass('active')) {
          $(this).toggleClass('active');
          return query.asign({
            filter_by: 'category',
    ...
    QueryString = (function() {
      ...
      QueryString.prototype.asign = function(id) {
      ...
      QueryString.prototype.send_query = function(params) {
        return $.ajax({
      ...
      QueryString.prototype.put_url = function(params) {
        var newurl;
